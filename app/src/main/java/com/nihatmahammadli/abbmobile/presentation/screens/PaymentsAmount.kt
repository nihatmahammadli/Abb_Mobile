package com.nihatmahammadli.abbmobile.presentation.screens
        ...
        class PaymentsAmount : Fragment() {
            ...
            override fun onCreateView(
                ...
                } else if (paymentHorizontal != null) {
                    Toast.makeText(requireContext(), "Horizontal seçildi: ${paymentHorizontal.title}", Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(requireContext(), "Heç bir payment seçilməyib", Toast.LENGTH_SHORT).show()
                }
            ...
            private fun setupTransferButton() {
                ...
                binding.transferBtn.setOnClickListener {
                    ...
                    when {
                        ...
                        amount <= 0.0 -> Toast.makeText(requireContext(), "Məbləğ sıfırdan böyük olmalıdır", Toast.LENGTH_SHORT).show()
                        else -> {
